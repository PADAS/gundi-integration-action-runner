...
from gundi_action_runner.testing.fixtures import AsyncMock
from gundi_action_runner.services.action_scheduler import trigger_actions
...
async def test_trigger_actions_publishes_every_command_in_one_batch(mocker):
    ...
    mocker.patch("gundi_action_runner.services.action_scheduler.publish_events", mock_publish_events)
...
async def test_trigger_actions_runs_each_action_inline_in_sync_mode(mocker):
    ...
    mocker.patch("gundi_action_runner.services.action_runner.execute_action", mock_execute_action)
    mock_publish_events = AsyncMock()
    mocker.patch("gundi_action_runner.services.action_scheduler.publish_events", mock_publish_events)
