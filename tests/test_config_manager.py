...
from gundi_action_runner.services.config_manager import (
...
async def test_set_action_configuration_with_ttl(
    ...
    from gundi_action_runner.services import config_manager as cm
...
async def test_present_webhook_config_gets_the_default_ttl_when_caller_passes_none(
    ...
    mocker.patch("gundi_action_runner.services.config_manager.redis", mock_redis_empty)
    mocker.patch("gundi_action_runner.services.config_manager.GundiClient", mock_gundi_client_v2_class_for_webhooks)
    config_manager = IntegrationConfigurationManager()
    integration_id = str(integration_v2_with_webhook.id)
...
async def test_a_legacy_permanent_webhook_entry_gets_the_default_ttl_on_its_next_hit(
    ...
    from gundi_action_runner.services.config_manager import WEBHOOK_CONFIG_DEFAULT_TTL_SECONDS
